    ...
    <section className="hero section-reveal">
      <div className="hero-copy">
        ...
        <p className="hero-summary">
          ...
          with hands on experience in Microsoft Azure. Proven ability to deliver
          efficient, user-focused solutions in Agile team environments.
        </p>
      ...
      <div className="hero-center" aria-hidden="true">
        <div className="hero-image-wrapper">
          ...
          <aside className="hero-highlights" aria-label="Social media links">
            ...
            {/* E-mail */}
            <a
              className="hero-social social-2"
            ...
            {/* Phone */}
            <a
              className="hero-social social-3"
              href="tel:+94769396646"
              aria-label="Phone"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            {/* GitHub */}
            <a
              className="hero-social social-5"
